		...
		<div class="search-result">
			<?php
				if($records->num_rows() == 0){
					...
					echo "<div style='width:100%; text-align:center; font-size:1.3em; margin-top:130px'>Click <a href=".base_url()."index.php/recipe/browse_recipe>here</a> to browse recipes</div>";
				}
				else
				{
				// loop through the result table
					foreach($records->result() as $row)
					{
						...
						echo '<button class="gh-button danger icon remove">';
						echo 'Unfavorites';
						echo '</button>';
						echo '</a>';
						echo '</div>';
