          ...
          <table class="edit-hidden" id="form_height" style="display:none;">
            <form method="post" action="<?php echo base_url(); ?>index.php/user/update_profile/form_height" autocomplete="off">
              <tr>
                ...
                <td><input name="height" type="number" min="30" value="0" autocomplete="off" style="width:50px;margin-left:10px;"/>cm</td>
              </tr>
              <tr>
                <td></td>
                <td>
          ...
          <table class="edit-hidden" id="form_weight" style="display:none;">
            <form method="post" action="<?php echo base_url(); ?>index.php/user/update_profile/form_weight" autocomplete="off">
              <tr>
                ...
                <td><input name="weight" min="2" type="number" value="0" style="width:50px;margin-left:10px;"/>kg</td>
              </tr>
              <tr>
                <td></td>
                <td>
            ...
            <tr>
              ...
              <td>
                ...
                else
                {
                  ...
                  if (isset($hal) and $hal == 1) echo "Halal;";
                  else echo "Not halal;";
                }
                ?>
              </td>
              ...
              <tr>
                ...
                <td>
                  <?php
                    ...
                    if (isset($this->session->userdata('user')->halal) and $this->session->userdata('user')->halal==1)
                      echo '<input type="checkbox" name="preference[]" value="halal" checked="yes">Halal';
                    else
                      echo '<input type="checkbox" name="preference[]" value="halal">Halal';
                  ?>
